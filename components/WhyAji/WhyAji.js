      ...
      <div className="why-aji-container">
        <div className="why-aji-header">
          ...
          <p className="why-aji-subdesc">
            Aji is an all in one travel guide to Morocco. Want to learn how to get your visa? buy an e-sim? or discover touristic sites and activities during your stay in Morocco? AJI is here to help you plan all aspects of your next trip to Morocco. Download AJI now!
          </p>
        </div>
